...
class XmlClass:
    ...
    def getSetAttributes(self, indent, fullyQualifiedName, language):
        ...
        if language.lower() == "c++":
            ...
            text += indent + " */\n"
            text += indent + "unsigned " + fullyQualifiedName + "::setAttributes(const char **attrs) \n"
            text += indent + "{\n"
    ...
    def getAddSubEntity(self, indent, fullyQualifiedName, language):
        ...
        if language.lower() == "c++":
            ...
            text += indent + " */\n"
            text += indent + "XML::Serializable *" + fullyQualifiedName + "::addSubEntity(const char *name, const char **attrs) \n"
            text += indent + "{\n"
    ...
    def getDecl(self, indent, parentQualName, language):
        ...
        if language.lower() == "c++":
            ...
            if self._protocolType == "boostXML" or self._protocolType == "boostBinary" or self._protocolType == "boostText":
                ...
                text += indent + "   *           if there was a problem setting the new XML attributes.\n"
                text += indent + "   */\n"
                text += indent + "  virtual unsigned setAttributes(const char **attrs) ;\n"
                text += "\n"
                text += indent + "  /*!\n"
                text += indent + "   * Adds an XML subentity.\n"
                text += indent + "   *\n"
                ...
                text += indent + "   *           if there was a problem adding the new XML subentity.\n"
                text += indent + "   */\n"
                text += indent + "  XML::Serializable* addSubEntity(const char *name, const char **attrs) ;\n"
                text += "\n"
                text += indent + "  /*!\n"
                text += indent + "   * Writes the XML members to an output stream.\n"
                text += indent + "   *\n"

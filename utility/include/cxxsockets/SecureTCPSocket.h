...
class SecureTCPSocket : public TCPSocket {
  public:
     ...
     */
    SecureTCPSocket(const TCPSocketPtr& socket,                              //!< [in]
    ...
    void Connect(const SockAddr& remote_sa,                               //!< [in] SockAddr object specifying the remote address to connect
    ...
    void MakeSecure(const bgq::utility::ClientPortConfiguration& port_config //!< [in]
    );

    void MakeSecure(const bgq::utility::ServerPortConfiguration& port_config //!< [in]
    );
    ...
    int Send(const Message& msg //!< [in] msg  Message object to send.
    );
    ...
    int Receive(Message& msg //!< [in] msg Message object to receive.
    );

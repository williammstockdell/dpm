...
BOOST_AUTO_TEST_CASE(test_single_string) {
    ...
    exp_pairs += PortConfiguration::Pair("localhost", "55901");
...
BOOST_AUTO_TEST_CASE(test_string_ports_multi) {
    ...
    PortConfiguration::Pairs exp_pairs;
    exp_pairs += PortConfiguration::Pair("localhost", "55901"), PortConfiguration::Pair("::1", "55902");
...
BOOST_AUTO_TEST_CASE(test_strings) {
    ...
    PortConfiguration::Pairs exp_pairs;
    exp_pairs += PortConfiguration::Pair("localhost", "55901"), PortConfiguration::Pair("bmw323.rchland.ibm.com", "55902"), PortConfiguration::Pair("::1", "32061");

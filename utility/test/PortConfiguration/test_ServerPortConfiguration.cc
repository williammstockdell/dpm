...
BOOST_AUTO_TEST_CASE(test_default) {
    ...
    exp_pairs += PortConfiguration::Pair(ServerPortConfiguration::DefaultHostname, "32061");
...
BOOST_AUTO_TEST_CASE(test_no_port_type) {
    ...
    PortConfiguration::Pairs exp_pairs;
    exp_pairs += PortConfiguration::Pair("test1", "55903");
...
BOOST_AUTO_TEST_CASE(test_port_type_name_options) {
    ...
    ServerPortConfiguration port_config("32062", "console", "real-time console");
    ...
    BOOST_CHECK_EQUAL(lexical_cast<string>(desc_visible), string() +
                                                              ...
                                                              "Visible:\n"
                                                              "  --console-" +
                                                              ServerPortConfiguration::OptionName + " arg Ports to accept real-time console connections on\n"
    ...
    PortConfiguration::Pairs exp_pairs;
    exp_pairs += PortConfiguration::Pair("::1", "55902");
...
BOOST_AUTO_TEST_CASE(test_command_line) {
    ...
    PortConfiguration::Pairs exp_pairs;
    exp_pairs += PortConfiguration::Pair("::1", "32061");

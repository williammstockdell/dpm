...
class AgentRep : public AgentBase, public std::enable_shared_from_this<AgentRep> {
    ...
    void executePolicy_nl(const BinaryId& reqbid, AgentRepPtr rep_p, AliasPtr al, int signo = 0);
  ...
  public:
    ...
    void stopBinaryAndExecutePolicy(const BinaryId& bid, const BinaryLocation& binloc, const int signal, BGMasterAgentProtocolSpec::StopReply& stoprep, const std::string& trigger);
    ...
    void cancel(bool binaries, int signal);

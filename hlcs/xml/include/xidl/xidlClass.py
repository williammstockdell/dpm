...
class Class:
    ...
    def writeStandardMethodDeclarationsDecl_C(self):
        ...
        print self.getIndent() + "   */"
        print self.getIndent() + "  virtual unsigned setAttributes(const char **attrs);"
        print
        print self.getIndent() + "  /*!"
        ...
        print self.getIndent() + "   */"
        print self.getIndent() + "  XML::Serializable* addSubEntity(const char *name, const char **attrs);"
        print
        print self.getIndent() + "  /*!"
...
#            c.writeStandardMethods_C()
    ...
    def writeSetAttributesMethod_C(self):
        ...
        print " */"
        print "unsigned " + self.fullyQualifiedName_C() + "::setAttributes(const char **attrs)  {"
        print "  unsigned i = 0;"
    ...
    def writeAddSubEntityMethod_C(self):
        ...
        print " */"
        print "XML::Serializable *" + self.fullyQualifiedName_C() + "::addSubEntity(const char *name, const char **attrs)  {"
        # need to set parent class attributes, if any
        if self._parentClass != None:
            if self._parentClass != "XML::Serializable":
                print "  try {"
